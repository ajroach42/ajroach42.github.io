...
**Writing:** Nano, Vi, Emacs, Ed, Mp, Wordgrinder... There are a pleathora of highly expandable, widely loved text editors and word proccessors available for the linux command line. The majority of them are fully interactive, and can be used from every computer on our list. 

**Email:** I use Mutt as my primary email client. I've also heard good things about pine, and I'm sure there are others. 

**Live Chat:** Shared unix servers invinted live chat. There are dozens of services, from talk to IRC to XMPP. I prefer to use Finch and irssi, but there are litterally hundreds of options. For years I swore by nAIM, but with the closure of AOL Instant Messenger I'd be surprised if it still works. 
...
**Books:** I mostly keep my library in epub, which I can convert to html and read with any of the many CLI web browsers using pandoc. I have that proccess aliased to a command called "read" so in practice I just type "read house-of-leaves.epub" and then I don't have to worry about anything else. 
...
**Writing:**  5/5
Default keyboard isn't bad, and plenty of third party upgrades are available. Can write directly on the machine and transfer files via flash media or wirelessly. There are some seriously stellar word proccessors for the Mac.
...
**Data entry:** 3/5
Small screen, better for other tasks. Can certainly be used for data entry, but that's a wasted potential, in my opinion. (On the otherhand, your custom Hypercard application could serve as a front end to your database, or a way to pull reports, and then I would applaud.)  
...
**todo list:** 3/5
It would be possible to build an excelent to-do list manager with hypercard, that syncs back to our central file server. But it would probably still be better to do this through todo.sh on your application server. 

**Games (playing):** 4/5
Good sized ibrary of not bad games.
...
### Scorecard
Keep in mind that the 200LX can serve as a wireless serial terminal to handle all of the tasks we outlined above. It performs at this job admirably, especially considering it's small size and batery power. Beyond that, here's a quick rundown of how it performs (if I've left something off, it's because it doesn't really work here.) 

**Writing:**  3/5
GREAT software meets a decidedly mediocre keyboard. Well, no. That's unfair. 

The keyboard is not bad to use. It's very clicky and tactile. I liked typing on it, mostly. It's just the damn number pad I take an issue with. The numberpad should have been ommited. 
...
**Development:** 4/5  
Lots of development packages availble. None of them as good as hypercard, but some of them come close. Has compilers for nearly every language under the sun, and emulators on every modern platform. 
...
**Games (playing):** 4/5
Good sized ibrary of not bad games. Some are hard to see in greyscale, others run a little slowly becuase it's essentially a first gen IBM PC in the palm of your hand and of course that means it's a little slow. 
...
**Live Chat:** 4?/5
It appears there are lots of live chat applicatisons available, but I've never used any of them. 
...
**Development:** 3/5 
No more difficult to develop for than DOS or the Apple II, but fewer folks on the recieving end to run your applications, as emulators are further between.  

**Data entry:** 4/5
Good keybaord, good screen, can run custom applications. Perfect candidate for data entry. 
...
**Writing:**  4/5
Good software, generally good keyboards. Not as fun or as simple as others on the list, but 100% servicable. Can write directly on the machine and transfer files via flash media or wirelessly. Basically just like using a modern computer, but honestly probably faster in practice. 
...
**Graphic Design:** 5/5 
I learned Creative Suite on an iMac G5. Maybe don't try graphic design on the iBook, but the other two are good rto go. 
...
**Videophone**
Hook a computer up to one of these, and mount a little camera and mic around it somewhere and it becomes a video phone, that will 100% STUN your clients when they see it. I had a simple setup (not even particularly elligant, literally just a raspberry pi with a mouse and keyboard and webcam) set up for a few months, and everyone that saw me videoconferencing on it stopped and stared. 
...
**Monitor**
Most vintage computers need a monitor and have a composite video output. Most TVs can be a monitor and have (or can be rigged to take) a composite video input. Combine these two facts for fun and proffit. 

**Video Player** 
While most older computer can't actually play videos, they CAN (as we have well established) serve as serial terminals. Set up a media player attached directly to one of these TVs or using the broadcast method described at the top of the page, and toss together some bash scripts to display the available files and control playback (encorporate UPnP to enable folks on your local network to be able to control playback from their phones as well.) 
...
Of course, the above are far from the only vintage (or vintage adjacent) computers that'd I'd consider. They're just the ones on my mind right now. Here's a quik rundown of some other machines I've considered, or learned about recently and will be exploring.  
...
On the other hand, I know that the Amiga had an add-on card (the video toaster) that enabled it to be a strong SD video proccessing rig. With the right hardware and software, and a decent vintage camera, the Amiga and produce SD broadcast quality footage. The temptation to hunt one of those down is metered by the fact that they still cost about $1000, and the fact that I don't have time to get in to 3D animation and video production right now. (but hey, give me a few months and $1000.) 


### Armiga 

An Amiga, rebuilt on ARM for gaming mostly. Newly produced, legal emulator built aroaund a raspberry pi or adjacent. 
...
It's high on my list, because Douglas Adams used one while writing Last Chance to See, and I love Mr. Adams, but also I'm not sure if it could be easilly brought in to my workflow (specifically, it seems that the serial port is non-standard, and it does not use any modern storage.) 

### Risc OS on Pi 

Not exactly vintage, but running the OS from the Acorn Archemedies on the Raspberry Pi. It's not an emulator, it's am actual OS. 
...
!! What a great little thing. Two things are keeping it off the list: 1) The screen is aparently not wonderful, especially with the backlight off. 2) I [backed the project](https://www.indiegogo.com/projects/gemini-pda-android-linux-keyboard-mobile-device-phone) for it's modern successor which will allegedly ship this month. 
...
Wanting to appear less like a man slowly ageing out of his own demographic, drew takes a long slow sip of his too expensive coffee, closes his eyes, and leans back. On the ceiling, there is a flyer. The ceiling is very far away, and the flyer is a jumble of too many words. Drew's eyes have gotten worse since the last time he went to the eye doctor, and to him the flyer is almost impossible to read. At the bottom, in larger letters, it says "Basically, if you need help, we're four doors down. Look for the weird." 

'A flyer on the ceiling of a coffee shop that says "look for the weird." How could I pass that up?' he thinks. Hesitently he gathers his things together and steps out the door. Instinctively, he turns to the right back towards the little city's town-square and park. He watches the doors and counts. There are three. There was not a fourth. 

Drew is disapointed, and now he feels foolish. He turns to go back towards the coffee shop before realising that the little side street that plays host to Hot Beans Coffee Roasters does not in fact end at their door. That's just the furthest he'd ever been down this street. He walks past the coffee shop, past an empty store front, past a hair salon, past a church for a religion he was sure he'd never heard of, and then he noticed another door recessed in the wall, openning on to a staircase. 

The lettering on the door reads "Space Age Ideas: Wizards of the Electronic Age. We help, We consult, We build things, Come inside!" 
...
He pauses to take it all in, waiting for someone to acknowledge his entrance. Clearly some these people were working, he thought, but on what he could not begin to fathom. Their machines seemed to clearly be barely functional antiques, and yet every last one of them had an aire of the future to it. As he tried to reconcile all of this in his mind, he noticed the robot. 

It wasn't a large robot. It looked like a toy that might have been sold in the 1980s, but it moved with more grace than he expected. It rolled easilly across the uneven wooden floor and stopped in front of him. It's head was another TV screen, bulbous like a spaceman's helment, and there was a person's image displayed inside. 

"Hi, I'm Jerry!" the main inside the space helment TV set said, "This is Space Age Ideas. What can we help you with today?" 
...
"Neat!" Jerry responded from his robot. "This is space age ideas! We're wizards of the electronic age, and we're here to help. What's your name?" 

"Drew"

"Drew, Give me a second, I'll have someone show you around." The screen flickered, and Jerry's face was replaced with an electronic smile. 

"Can I Help You?" the robot said in a shockingly synthetic voice. 

"N..No. I'm just waiting" Drew said, unsure of the correct ettiquit for interacting with a robot. 

The bot turned around and wheeled itself away, heading towards one of the doors at the back of the room that opened as it approached. 

A young woman sitting in one of the almost pretentious chairs, clearly rocking out with a pair of headphones that were remarkably similar to the ones Drew had so recently stowed in his bag, closed a small device about the size of a paperback book, placed it on an end table, removed her headphones and walked torwards him. 

"Are you Drew?" she said. 
...
They walked around the office, and she introduced Drew to people, and telling him about the projects they were working on. There was Jerry doing robotics on what appeared to be an old black and white mac, John who built websites on electronic typewriters, Cheryll who apparently published magazines and flyers with the aide of what appeared to be a pocket calculator, and several other people who's jobs appeared to consist mostly of typing things in to the strangest computers Drew had ever seen, and then laughing wickedly at the computer's response. 

"So, what do you do?" the young woman asked.
...
Drew listens for a few minutes. He's impressed, and he says so. The minutes slip in to hours, as Drew makes new friends and plays video games and suddenly the thought occurs to him that this place has got to make money somewhere. 

He looks for Dianne, and asks her. 

"Oh! Well, yeah. I mean we build robots for people and host websites for other people and write computer games and there's a crew in the back doing a TV show right now and we publish books and..." she continues on like this for a few minutes "oh, and there's a tip jar by the door." 

"Do all of you work here?" 

She looks around for a moment "I do, Jerry does. The TV crew is renting the space. I think everyone else that's here today